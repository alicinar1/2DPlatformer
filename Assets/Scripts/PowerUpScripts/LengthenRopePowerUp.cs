...
public class LengthenRopePowerUp : MonoSingleton<LengthenRopePowerUp>, IPowerUpController
{
    ...
    public void ExecutePowerUp(GameObject player)
    {
        ...
        player.GetComponent<SpringJoint2D>().distance = (springJoint.distance * 2f);
    }
